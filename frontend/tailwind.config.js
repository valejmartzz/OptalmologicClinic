...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Colores primarios de la clínica (azul oftalmológico)
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Colores secundarios (morado para especialidad médica)
        secondary: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
        ...
        medical: {
          blue: '#1e40af',       // Azul médico
          teal: '#0d9488',       // Verde médico
          cyan: '#0891b2',       // Cian para diagnóstico
          amber: '#f59e0b',      // Ámbar para alertas
          rose: '#e11d48',       // Rojo para emergencias
        ...
        appointment: {
          ...
          completed: '#3b82f6',  // Azul - Completada
      ...
      animation: {
        // Animaciones para la interfaz de clínica
